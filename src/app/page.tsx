    ...
    return (
        <div className="flex flex-col items-center justify-center text-white space-y-6">
            ...
            <h1 className="text-2xl">
                Rewarding <span className=" text-purple-400">open source </span>
                contributions one commit at a time{' '}
            </h1>
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-4">
                <Link
                    href="/sign-up"
                    className="px-6 py-3 bg-white text-black rounded-lg font-semibold shadow-md hover:bg-white transition"
                >
                    Get Started
                </Link>
                <Link
                    href="/learnmore"
                    className="px-6 py-3 bg-[#666566] text-black rounded-lg font-semibold shadow-md hover:bg-white transition"
                >
                    Learn More
                </Link>
                <Link
